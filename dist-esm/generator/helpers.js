...
export function getFieldTSType(dmmfDocument, typeInfo, isRequired, isInputType, modelName, typeName) {
...
export function mapScalarToTSType(scalar, isInputType) {
    switch (scalar) {
...
export function getTypeGraphQLType(typeInfo, dmmfDocument, modelName, typeName, isIdField) {
...
export function mapScalarToTypeGraphQLType(scalar, emitIdAsIDType, isIdField) {
...
export function getModelNameFromInputType(inputTypeName) {
...
export function getInputTypeName(originalInputName, dmmfDocument) {
...
export function getModelNameFromOutputType(outputTypeName) {
...
export function cleanDocsString(documentation) {
    if (!documentation) {
        return;
    }
...
export function convertNewLines(str) {
    return str.split('\\n').join('\n');
}
export function toUnixPath(maybeWindowsPath) {
    return maybeWindowsPath.split('\\').join('/');
}
export function getArguments(typeGraphQLType, docs, nullable, isAbstract, simpleResolvers) {
    const args = [];
    if (typeGraphQLType)
