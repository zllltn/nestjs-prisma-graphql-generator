...
exports.modelAttributeRegex = /(@@NestJsGraphQL\.)+([A-z])+(\()+(.+)+(\))+/;
exports.fieldAttributeRegex = /(@NestJsGraphQL\.)+([A-z])+(\()+(.+)+(\))+/;
...
function parseDocumentationAttributes(documentation, expectedAttributeName, expectedAttributeKind) {
    var _a, _b, _c, _d, _e;
    const attributeRegex = expectedAttributeKind === 'model' ? exports.modelAttributeRegex : exports.fieldAttributeRegex;
