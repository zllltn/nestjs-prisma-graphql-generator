...
const generateResolver = (project, outputDir, model) => {
    const modelName = (0, helpers_1.camelCase)(model.name);
    const filePath = path_1.default.resolve(outputDir, `${modelName}/${modelName}.resolver.ts`);
...
//# sourceMappingURL=generateResolver.js.map